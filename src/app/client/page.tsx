...
/**
 * Single-page client portal — everything a client needs lives here:
 * a compact profile strip up top (name + package + note-to-trainer)
 * and the calendar below, where every action (request, cancel,
 * upgrade-to-in-app, log cycle) is wired inline.
 */
