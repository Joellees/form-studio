...
import { Beta2PlanPicker } from "./beta2-plan-picker";
...
export default async function ExpiredPage() {
  ...
  return (
    ...
    >
      ...
      {cohort === "beta_2" ? (
        // Beta 2 plan picker — selectable cards + single CTA below.
        // State (which card is picked) lives in a small client
        // component so the page itself can stay server-rendered.
        // The pre-filled WhatsApp message is built inside the
        // picker based on the chosen cadence.
        <Beta2PlanPicker firstName={firstName} whatsappNumber={WHATSAPP_NUMBER} />
      ) : (
        // Non-Beta-2 cohorts (rare on this page — founders bypass
        // hasStudioAccess; mostly defensive). Keep the original
        // single card + a generic "WhatsApp us" CTA below.
        <>
